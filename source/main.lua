...
function setup()
  ...
  -- Create world
  world = playbox2d.world.new(0.0, 9.81, 10)
  world:setPixelScale(WORLD_PIXEL_SCALE)
  
  -- Create floor
  floor = playbox2d.body.new(FLOOR_WIDTH, FLOOR_HEIGHT, 0)
  ...
  -- Create ceiling
  ceiling = playbox2d.body.new(CEILING_WIDTH, CEILING_HEIGHT, 0)
  ...
  for i = 1, BOX_COUNT do
    ...
    local box = playbox2d.body.new(math.random() * 0.3 + 0.2, math.random() * 0.3 + 0.2, box_mass)
